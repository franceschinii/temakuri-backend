export interface ChangelogSeedEntry {
  date: string;
  version: string;
  title: string;
...
/**
 * Seed do changelog — usado UMA vez pelo ChangelogService.seedIfEmpty()
 * para popular a tabela no primeiro boot apos a migration. Depois disso
 * a fonte de verdade e o banco (editavel via admin).
 */
export const CHANGELOG_SEED: ChangelogSeedEntry[] = [
  {
    date: '2026-05-14',
    version: '0.6.5',
