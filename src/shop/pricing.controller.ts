...
const DEFAULTS: { kind: PriceKind; key: string; label: string; unit: string; def: number }[] = [
  ...
  { kind: 'avatar_diamonds', key: '15', label: 'Avatar Gaviões', unit: 'diamantes', def: 100 },
  ...
  { kind: 'theme', key: 'sakura', label: 'Tema Sakura', unit: 'diamantes', def: 75 },
  { kind: 'theme', key: 'oni', label: 'Tema Oni', unit: 'diamantes', def: 150 },
  { kind: 'theme', key: 'gavioes', label: 'Tema Gaviões', unit: 'diamantes', def: 100 },
